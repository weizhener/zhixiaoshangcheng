    ...
    <div class="fontl">
        <form method="get">
            <div class="left">
                ...
                <input type="hidden" name="act" value="epay" />
            ...
            <a class="left formbtn1" href="index.php?app=customer_message&act=epay">撤销检索</a>
            <?php endif; ?>
        </form>
    </div>
    <div class="fontr">
...
<div class="tdare">
    <table width="100%" cellspacing="0" class="dataTable">
        ...
        <tr class="tatr1">
            ...
            <td align="left">汇款人姓名</td>
            <td align="left">汇款人电话</td>
            <td align="left">汇款信息</td>
