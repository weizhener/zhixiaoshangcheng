...
?>
    <tr class="tatr2">
      ...
      <td> 
          <?php if ($this->_var['goods']['evaluation'] == '3'): ?>好评<?php endif; ?>
          <?php if ($this->_var['goods']['evaluation'] == '2'): ?>中评<?php endif; ?>
          <?php if ($this->_var['goods']['evaluation'] == '1'): ?>差评<?php endif; ?>
      </td>
      <td><?php echo htmlspecialchars($this->_var['goods']['comment']); ?></td>
      <td>
          <?php echo local_date("Y-m-d",$this->_var['goods']['evaluation_time']); ?>
      </td>
      <td class="handler">
      <span style="width: 50px">
      <a href="index.php?app=evaluation&amp;act=edit_buyer&amp;rec_id=<?php echo $this->_var['goods']['rec_id']; ?>">修改</a>|<a href="index.php?app=evaluation&amp;act=drop&amp;rec_id=<?php echo $this->_var['goods']['rec_id']; ?>">删除</a>
      </span>
      </td>
    </tr>
    <?php endforeach; else: ?>
