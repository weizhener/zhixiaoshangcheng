<div class="eject_con">
    ...
    <div class="edit_table">
        ...
        <form action="index.php?app=goods&amp;act=spec_edit&amp;id=<?php echo $this->_var['goods']['goods_id']; ?>" method="POST" target="iframe_post">
...
?>
                <tr>
                    ...
                    <td class="align2"><input type="text" class="text width2" name="gh_price[<?php echo $this->_var['spec']['spec_id']; ?>]" value="<?php echo $this->_var['spec']['gh_price']; ?>" /></td>
