...
<div id="rightTop">
    <p>投诉及建议</p>
    <ul class="subnav">
        <li><a class="btn1" href="index.php?app=customer_message">用户建议</a></li>
        <li><span>店铺投诉</span></li>
...
<div class="mrightTop">
    <div class="fontl">
        <form method="get">
            ...
            <a class="left formbtn1" href="index.php?app=customer_message&act=store">撤销检索</a>
            <?php endif; ?>
        </form>
    </div>
    <div class="fontr">
...
?>
        <tr class="tatr2">
            ...
            <td align="left"><a href="<?php echo $this->_var['site_url']; ?>/index.php?app=store&amp;id=<?php echo $this->_var['customer_message']['store_id']; ?>" target="_blank"><?php echo htmlspecialchars($this->_var['customer_message']['store_name']); ?></a></td>
