        ...
        <table class="infoTable">
            ...
            <tr>
                ...
                <td class="paddingT15 wordSpacing5">
                    <input class="infoTableInput" id="title" type="text" name="title" value=""/>
            ...
            <tr>
                <th class="paddingT15">
                    积分金额:</th>
                <td class="paddingT15 wordSpacing5">
                    <input class="infoTableInput" id="money" type="text" name="money" value=""/>
            ...
            <tr>
                <th class="paddingT15">
                    中奖概率:</th>
                <td class="paddingT15 wordSpacing5">
                    <input class="infoTableInput" id="gailv" type="text" name="gailv" value=""/>
             ...
             <tr>
                <th class="paddingT15">
                    奖品数量:</th>
                <td class="paddingT15 wordSpacing5">
                    <input class="infoTableInput" id="num" type="text" name="num" value=""/>
            ...
            <tr>
                <th class="paddingT15">
                    指针角度:</th>
                <td class="paddingT15 wordSpacing5">
                    <input class="infoTableInput" id="zhizhen" type="text" name="zhizhen" value=""/>
