...
<div class="mrightTop">
    <div class="fontl">
        <form method="get">
            ...
            <a class="left formbtn1" href="index.php?app=customer_message&act=goods">撤销检索</a>
            <?php endif; ?>
        </form>
    </div>
    <div class="fontr">
...
?>
        <tr class="tatr2">
            ...
            <td align="left"><a href="<?php echo $this->_var['site_url']; ?>/index.php?app=goods&amp;id=<?php echo $this->_var['customer_message']['goods_id']; ?>" target="_blank"><?php echo htmlspecialchars($this->_var['customer_message']['goods_name']); ?></a></td>
