...
<div id="nav">
    ...
    <ul>
        ...
        <li><a class="<?php if ($_GET['app'] == 'store' && $_GET['act'] == 'search'): ?>active<?php else: ?>normal<?php endif; ?>" href="<?php echo url('app=store&act=search&id=' . $this->_var['store']['store_id']. ''); ?>" ><span>店铺商品</span></a></li>
