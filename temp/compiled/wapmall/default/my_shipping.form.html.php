...
<style>
.info_table_wrap h3{text-align: center}
.info_table {width:100%;overflow: hidden;}
.info_table li {width: 100%;overflow: hidden;float: left;padding-bottom:0px;}
.info_table h4 {float: left;width: 100%;font-weight: normal;color: #656565;font-size: 12px;text-align: center}
.info_table p {text-align: center;word-spacing: 5px;width: 100%}
.info_table p textarea {vertical-align: top;width: 90%;margin:2%;height: 60px;overflow-y: auto;}
.info_table p .text,.info_table p select{width: 90%;margin:2%;}
.info_table p span {color: #b4b4b4;width: 100%}
.info_table select{border: 1px solid #A7A6AA;
height: 22px;
padding: 1px;
line-height: 22px;
margin-right: 2px;
