    ...
    <script type="text/javascript">
        ...
        <div class="login_panel">
            ...
            <form class="login_box"  method="post" id="login_form">
                ...
                <p style="font-size:12px; padding:5px;">还不是会员？<a href="<?php echo url('app=member&act=register&ret_url=' . $this->_var['ret_url']. ''); ?>" >立即注册</a> | <a href="index.php?app=find_password" style="color: #666;">找回密码</a></p>
