            ...
            <div class="w">
                ...
                <div class="m1">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td class="t1"><strong>给卖家的附言：</strong><?php echo htmlspecialchars($this->_var['order']['postscript']); ?></td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="t1"><strong>店铺名：</strong><?php echo htmlspecialchars($this->_var['order']['store_name']); ?></td>
