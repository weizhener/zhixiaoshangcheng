     ...
     <em class="btn-dropdown"></em>
        ...
        <div class="homebg">
        	<div class="w990 clearfix">
            	<div area="travel_top" widget_type="area" class="top">
                    <?php $this->display_widgets(array('page'=>'ju_travel','area'=>'travel_top')); ?>
                </div>
                <div class="clearfix">
                    <div area="travel_left" widget_type="area" class="left">
                        <?php $this->display_widgets(array('page'=>'ju_travel','area'=>'travel_left')); ?>
                    </div>
                    <div area="travel_right" widget_type="area" class="right">
                        <?php $this->display_widgets(array('page'=>'ju_travel','area'=>'travel_right')); ?>
                    </div>
                </div>
            </div>
        
            <div class="content channel">
                 <div area="travel_floor" widget_type="area">
                    <?php $this->display_widgets(array('page'=>'ju_travel','area'=>'travel_floor')); ?>
                 </div>
            </div>
        </div>
</div>
