        ...
        <div class="wrap">
            <div class="public">
                ...
                <table id="refund-list" border="0" cellpadding="0" cellspacing="0">
                	<tr class="thead">
                    	<td width="80">退款编号</td>
                        <td width="140" class="pl10">订单编号/宝贝信息</td>
                        <td width="110">卖家</td>
                        <td width="80">交易金额</td>
                        <td width="80">退款总额</td>
...
?>
                	<tr class="tbody">
                        ...
                        <td><a href="<?php echo url('app=store&id=' . $this->_var['refund']['seller_id']. ''); ?>" target="_blank"><?php echo $this->_var['refund']['store_name']; ?></a><br /><?php echo $this->_var['refund']['user_name']; ?></td>
