...
<div id="page-apply" class="w mt10 mb20">
   ...
   <div class="title padding5 strong fs14">店铺续费</div>
...
?>
         ...
         <dd class="float-left" style="width:100px;"><a href="<?php echo url('app=renew&step=2&id=' . $this->_var['sgrade']['grade_id']. ''); ?>" class="btn-apply fs14 strong fff center">立即续费</a></dd>
