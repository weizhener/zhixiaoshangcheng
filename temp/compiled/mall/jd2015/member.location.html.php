            ...
            <div class="public">
                <form method="post">
                    <div class="user_search">
                        <span>经度: </span>
                        <input id="lng" name="lng" class="text1 width13" type="text" value="<?php echo $this->_var['member_info']['lng']; ?>">
                        <span>纬度: </span>
                        <input id="lat" name="lat" class="text1 width13" type="text"  value="<?php echo $this->_var['member_info']['lat']; ?>">
                        <span>层级: </span>
                        <input id="zoom" name="zoom" class="text1 width13" type="text"  value="<?php echo $this->_var['member_info']['zoom']; ?>">
...
// 百度地图API功能
                ...
                map.centerAndZoom(point, <?php echo $this->_var['member_info']['zoom']; ?>);
