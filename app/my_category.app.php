	        ...
	        if($file['name'])
	     	{
				...
				$save_path= "data/files/mall/catpic";
				...
				$filename  = 'catpic_'.$cate_id;
				$data2['catpic'] = $file_path = $uploader->save($save_path, $filename);
			}

			$cate_id = $this->_gcategory_mod->edit($cate_id,$data2);
	        ...
	        if($file['name'])
	     	{
				...
				$uploader->root_dir(ROOT_PATH);
				$filename  = 'catpic_'.$id;
				$data['catpic'] = $file_path = $uploader->save($save_path, $filename);
			}
