...
class DefaultPassportUser extends BasePassportUser
{
    ...
    /* 注册 */
    function register($user_name, $password, $email,$real_name,$identity_card,$telephone, $local_data = array())
    {
   ...
   //    {
    //        return false;
     //   }
        ...
        $local_data['reg_time']     = gmtime();                $local_data['real_name']=$real_name;                $local_data['identity_card']=$identity_card;                $local_data['phone_mob']=$telephone;
