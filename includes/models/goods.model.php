...
class GoodsModel extends BaseModel {
    ...
    function get_list($params = array(), $scate_ids = array(), $desc = false, $no_picture = true) {
        ...
        $fields .= "g.goods_id,g.status, g.store_id, g.type, g.goods_name, g.cate_id, g.cate_name, g.brand, g.spec_qty, g.spec_name_1, g.spec_name_2, g.if_show, g.closed, g.add_time,g.gh_price,g.fengcheng,g.is_pass, g.recommended, g.default_image,g.mall_recommended,g.mall_sort_order, " .
                "gs.spec_id, gs.spec_1, gs.spec_2, gs.color_rgb, gs.price,gs.gh_price, gs.stock, " .
