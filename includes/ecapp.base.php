...
define('SIZE_GOODS_IMAGE', '20971520');   // 商品大小限制20M

define('SIZE_STORE_LOGO', '204800');      // 店铺LOGO大小限制20OK
...
define('SIZE_CSV_TAOBAO', '20971520');     // 淘宝助理CSV大小限制20M
...
define('INTEGRAL_DZP', 10);  // 兑换礼品删减积分

define('INTEGRAL_DATE', 11);  // 兑换礼品删减积分

define('INTEGRAL_DZP2', 12);  // 砸金花
...
define('EPAY_KAIDIAN',130); // 交易成功扣除佣金
